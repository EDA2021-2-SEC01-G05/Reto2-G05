...
def compareMedio(catalog):
 """"""

def addArtworkMedium(catalog):
    """"""

def compareNacionalidad(catalog):
    """"""
# Requerimiento 3
...
def getArtworksNationality(catalog, codes, cmpf, lista):
    """
    Copia una lista con nueva cmpfunction cmpf
    """
    copia = lt.newList("ARRAY_LIST",cmpf)
...
def masAntiguasD(catalog,department, fechas):
    """
